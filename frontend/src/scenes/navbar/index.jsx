...
import FlexBetween from "components/FlexBetween" //REUTILIZACION DEL COMPONENTE CREADO


const Navbar = ()=>{
    //setear el estado para mobile
    ...
    <FlexBetween gap="2rem">
        {/*SETEO DEL CAMBIO DE MODO OSCURO Y CLARO*/}
        ...
        <FormControl variant="standar" value={fullName}>
            <Select 
            value={fullName}
